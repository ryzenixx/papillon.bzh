...
<div class="hero">
  ...
  <div class="content">
    <a class="britanny-chip" href="/kenavo">
      ...
      <p>
        Un logiciel libre imaginé en Bretagne
      </p>
    </a>
    ...
    <p class="conditions">
      En continuant, vous acceptez les <a href="https://safety.getpapillon.xyz/documents/terms-of-service">conditions d'utilisation</a> et la <a href="https://safety.getpapillon.xyz/documents/privacy-policy">politique de confidentialité</a>.
    </p>
  </div>

  <div class="screenshots">
    <img src="/assets/hero_screenshot_grades.png" alt="Screenshot des notes" class="screenshot screenshot-grades" />

    <img src="/assets/hero_screenshot_main.png" alt="Screenshot de l'application" class="screenshot screenshot-main" />

    <img src="/assets/hero_screenshot_edt.png" alt="Screenshot des cours" class="screenshot screenshot-edts" />
  </div>
</div>